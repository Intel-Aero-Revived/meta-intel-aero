...
HOMEPAGE = "https://github.com/intel-aero-revived/collision-avoidance-library"
LICENSE = "Apache-2.0"
...
SRCREV = "${AUTOREV}"
SRC_URI = "gitsm://git@github.com/intel-aero-revived/collision-avoidance-library.git;protocol=https;branch=master"
